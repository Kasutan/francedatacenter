...
function fdc_get_picto_inline($name) {
	...
	elseif($name=='loupe') : 
		return '<svg xmlns="http://www.w3.org/2000/svg" width="43.666" height="43.666" viewBox="0 0 43.666 43.666"><path d="M43.365,41.071l-11-11a1.012,1.012,0,0,0-.725-.3h-.878a17.56,17.56,0,1,0-.989,1v.87a1.049,1.049,0,0,0,.3.725l11,11a1.024,1.024,0,0,0,1.45,0l.844-.844A1.024,1.024,0,0,0,43.365,41.071ZM17.738,32.748A15.009,15.009,0,1,1,32.748,17.738,15,15,0,0,1,17.738,32.748Z" fill="#fff"/></svg>';
	endif;
